...
"""
Exponential Moving Average (EMA) module for PyTorch models.
Adapted from Fairseq's EMAModule to be standalone and generic.
...
class EMAModule:
    """Exponential Moving Average of PyTorch Models"""
    ...
    def __init__(
        ...
        @param config EMAModuleConfig object with configuration like
        ema_decay, ema_fp32
        @param copy_model If True, deep copy the model. If False, use the model directly.
        @param device If provided, copy EMA to this device (e.g. gpu).
        Otherwise EMA is in the same device as the model.
        @param skip_keys Set of parameter keys to skip during EMA update
        """
